...
def test_multiplication():
    ...
    assert simple_calculator("multiply", -3, -3) == 9   # Test for multiplication of two negative numbers
...
def test_division():
    ...
    assert simple_calculator("divide", -6, -3) == 2     # Test for division of two negative numbers
